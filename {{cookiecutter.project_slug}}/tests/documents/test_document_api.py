...
def test_anonymous_user_can_not_retrieve_chapter_list(apiclient,
                                                      module_factory):
...
def test_anonymous_user_can_not_retrieve_chapter_detail(
        apiclient, chapter_factory, module_factory):
    module = module_factory()
...
@pytest.mark.django_db
def test_anonymous_user_can_not_create_chapter(apiclient, module_factory):
    module = module_factory()
    url = reverse('chapters-list', kwargs={'module_pk': module.pk})
    data = {
        'chapters': [
...
@pytest.mark.django_db
def test_moderator_can_create_chapter(apiclient, module_factory):
    module = module_factory()
...
def test_moderator_cannot_create_chapter_in_other_module(
        apiclient, module_factory, project_factory):
    module = module_factory()
...
@pytest.mark.django_db
def test_chapters_are_correctly_sorted(apiclient, module_factory):
    module = module_factory()
    project = module.project
    moderator = project.moderators.first()
    apiclient.force_authenticate(user=moderator)
...
@pytest.mark.django_db
def test_paragraphs_are_correctly_sorted(apiclient, module_factory):
    module = module_factory()
    project = module.project
    moderator = project.moderators.first()
    apiclient.force_authenticate(user=moderator)
...
@pytest.mark.django_db
def test_moderator_can_delete_chapter(apiclient, module_factory):
    module = module_factory()
    project = module.project
    moderator = project.moderators.first()
    apiclient.force_authenticate(user=moderator)
...
@pytest.mark.django_db
def test_moderator_can_delete_paragraph(apiclient, module_factory):
    module = module_factory()
    project = module.project
    moderator = project.moderators.first()
    apiclient.force_authenticate(user=moderator)
...
@pytest.mark.django_db
def test_moderator_can_update_chapter(apiclient, module_factory):
    module = module_factory()
    project = module.project
    moderator = project.moderators.first()
    apiclient.force_authenticate(user=moderator)
...
@pytest.mark.django_db
def test_moderator_can_update_paragraph(apiclient, module_factory):
    module = module_factory()
    project = module.project
    moderator = project.moderators.first()
    apiclient.force_authenticate(user=moderator)
...
@pytest.mark.django_db
def test_moderator_can_update_and_create_chapter(apiclient, module_factory):
    module = module_factory()
    project = module.project
    moderator = project.moderators.first()
    apiclient.force_authenticate(user=moderator)
...
@pytest.mark.django_db
def test_moderator_can_update_and_create_paragraph(apiclient, module_factory):
    module = module_factory()
    project = module.project
    moderator = project.moderators.first()
    apiclient.force_authenticate(user=moderator)
